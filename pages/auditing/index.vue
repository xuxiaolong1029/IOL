...
<script>
	...
	export default {
		...
		onLoad(event) {
			console.log(Number(event.status))
...
<style lang="less" scoped>
	.page-tabs {
		...
		.page-tab-box {
			height: calc(100vh - 138px);width: 100vw;
			.uni-list{
				background-color: #FFFFFF;position: relative;
				width: 100%;
				&:before {
					position: absolute;height: 1px;transform: scaleY(.5);
					z-index: 10;right: 0;top: 0;left: 0;
					content: '';background-color: #c8c7cc;
				}
			}
			.uni-list-cell {
				position: relative;padding: 22rpx 30rpx;
				&:after {
				...
				.uni-media-list {
					...
					flex-direction: row;
					.uni-media-list-logo {
						height: 150rpx;width:220rpx;margin-right: 20rpx;
						image {
							height: 100%;width: 100%;
						}
					}
					.uni-media-list-body {
						display: flex;height: 150rpx;overflow: hidden;
						flex: 1;flex-direction: column;
						.uni-media-list-text-top {
							width: 100%;display: flex;justify-content: space-between;
							height:56rpx;line-height: 50rpx;font-size: 32rpx;
							.time{
								font-size: 26rpx;color: #8f8f94;
							}
						}
						.uni-media-list-text-bottom {
							width: 100%;height: 40rpx;margin-top: 10rpx;
							line-height:40rpx;display: flex;justify-content: space-between;
				...
				.uni-media-reject{
					width: 100%;margin-top: 10rpx;color: red;font-size: 26rpx;
					.text{
